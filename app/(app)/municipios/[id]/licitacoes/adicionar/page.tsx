...
import { BidStatus, BidModality } from "@/lib/types"
                ...
                <Card>
                    ...
                    <CardFooter className="flex justify-end border-t pt-6">
                        <Button type="submit" className="bg-[#EC610D] hover:bg-[#EC610D]/90" disabled={isSubmitting}>
                            {isSubmitting ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" /> Salvando...</> : <><Save className="mr-2 h-4 w-4" /> Salvar Licitação</>}
                        </Button>
                    </CardFooter>
                </Card>
            </form>
