...
import { FileText, Home, MapPin, Plus, Gavel, Wrench, ExternalLink } from "lucide-react"
    ...
    <div className="p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <div className="flex gap-2">
          ...
          <Button className="bg-[#EC610D] hover:bg-[#EC610D]/90"><FileText className="mr-2 h-4 w-4" /> Gerar Relatório</Button>
        </div>
      </div>
